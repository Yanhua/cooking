...
const weeks = [{ id:'2026-09-14', date:'Week of 14 September 2026', title:'Four dinners, nicely shared', dinners:[['taiwanese-lu-rou-fan','Pressure-cooker Taiwanese lu rou fan with bok choy and egg'],['mexican-pork-corn-skillet','Mexican pork, corn and zucchini rice skillet'],['vietnamese-caramel-chicken','Vietnamese caramel chicken with green beans and rice'],['italian-chicken-mushroom-zucchini-pasta','Italian chicken, mushroom and zucchini pasta']], reuse:['500 g pork-mince pack: 300 g for lu rou fan; 200 g for the Mexican skillet.','700 g chicken-thigh pack: 350 g for Vietnamese caramel chicken; 350 g for Italian pasta.','250 g mushrooms: 125 g in lu rou fan; 125 g in Italian pasta.','2 zucchini: one in the Mexican skillet; one in Italian pasta.','Rice: cooked in the rice cooker for lu rou fan, the Mexican skillet, and Vietnamese chicken.','Garlic bulb: shared across all four dinners; cooked onion is used in the Taiwanese and Mexican dishes.'], shopping:[{ category:'Fresh protein and produce', items:['700 g boneless chicken thighs','500 g pork mince','1 bag green beans (about 200 g)','1 red capsicum','2 zucchini','250 g mushrooms','1 bunch baby bok choy','2 brown onions','1 garlic bulb','6 eggs']},{ category:'Chilled and dry goods', items:['Parmesan (about 40 g)','200–250 g short pasta','1 can diced tomatoes (400 g)','Shredded cheese (about 100 g)','Rice, if needed (about 500 g dry for the week)']},{ category:'Pantry check', items:['Light soy sauce and dark soy sauce (or extra light soy sauce)','Fish sauce','Rice vinegar or white vinegar','Brown sugar','Chinese five-spice and 1 star anise (optional but recommended)','Tomato paste','Dried Italian herbs or oregano','Ground cumin, smoked paprika, and chilli powder','Frozen corn (about 150 g)','Olive oil']}] }];
...
const shoppingList = sections => sections.map(({ category, items }) => `<div class="shopping-group"><h3>${esc(category)}</h3><ul class="shopping">${items.map(item => `<li>${esc(item)}</li>`).join('')}</ul></div>`).join('');
