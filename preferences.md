...
- Maximum 30 minutes active cooking time per dinner.
- Buy fresh ingredients weekly from standard New Zealand supermarkets.
- Minimise waste: use standard fresh meat/chicken pack sizes across multiple dinners when possible, and share perishable vegetables across the plan.
- Ingredient batching must not override cuisine variety: reuse proteins and produce across different cuisines where practical.
- Normal pantry staples are available: soy sauce, salt, pepper, cooking oil, butter, and similar basics.
